	...
	static void adminMenu(Admin user, HashMap<Integer, Account> accounts, HashMap<String, User> users) {
		...
		do {	
			...
			case 3:
				...
				UserActions.withdraw((Customer)users.get(username), accounts, users);
			...
			case 4:
				...
				UserActions.deposit((Customer)users.get(username1), accounts, users);
			...
			case 5:
				...
				UserActions.transfer((Customer)users.get(username2), accounts, users);
